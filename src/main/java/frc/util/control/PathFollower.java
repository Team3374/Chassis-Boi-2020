...
import frc.util.motion.MotionProfileConstraints;
import frc.util.motion.MotionProfileGoal;
import frc.util.motion.MotionProfileGoal.CompletionBehavior;
import frc.util.motion.MotionState;
import frc.util.motion.ProfileFollower;
